...
public class MITH_SoundFXGrunt extends JFrame
{
   ...
   */
   ...
   public MITH_SoundFXGrunt() throws MalformedURLException
   {
      ...
      File file = new File("mooseGrunt.wav");
